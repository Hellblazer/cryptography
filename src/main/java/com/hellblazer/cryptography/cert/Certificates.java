 ...
 */
package com.hellblazer.cryptography.cert;
...
public class Certificates {
    ...
    public static X509Certificate sign(boolean useSubjectKeyIdentifier, BcX500NameDnImpl signerDn,
        ...
        try {
            ...
            SignatureAlgorithm.lookup(signerKeyPair.getPrivate()).signatureInstanceName()).build(
            ...
            final X509v3CertificateBuilder certBuilder = new X509v3CertificateBuilder(signerDn.getX500Name(),
                                                                                      ...
                                                                                      Date.from(notAfter),
                                                                                      dn.getX500Name(),
                                                                                      subPubKeyInfo).addExtension(
            Extension.authorityKeyIdentifier, false, extUtils.createAuthorityKeyIdentifier(signerKeyPair.getPublic()));
