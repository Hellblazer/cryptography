...
/**
 * Ye Enumeration of ye olde thyme Signature algorithms.
 *
...
public enum SignatureAlgorithm {
    ...
    ED_448 {
        ...
        @Override
        public JohnHancock sign(PrivateKey privateKey, InputStream message) {
    ...
    public abstract JohnHancock sign(PrivateKey privateKey, InputStream is);
